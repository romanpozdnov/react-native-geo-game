...
export class FoundAPI {
  ...
  static async getAll(): Promise<IFound[]> {
    const url = URL.found;
    return (await Axios.get<IFound[]>(url)).data;
  }
